...
namespace Fungus
{
    ...
    public class SayDialog : MonoBehaviour
    {
        ...
        public virtual void Say(string text, float writeSpeed, bool clearPrevious, bool waitForInput, bool fadeWhenDone, bool stopVoiceover, bool waitForVO, AudioClip voiceOverClip, Action onComplete)
        {
            StartCoroutine(DoSay(text, writeSpeed, clearPrevious, waitForInput, fadeWhenDone, stopVoiceover, waitForVO, voiceOverClip, onComplete));
        }
        ...
        /// <param name="voiceOverClip">Voice over audio clip to play.</param>
        /// <param name="onComplete">Callback to execute when writing and player input have finished.</param>
        public virtual IEnumerator DoSay(string text, float writeSpeed, bool clearPrevious, bool waitForInput, bool fadeWhenDone, bool stopVoiceover, bool waitForVO, AudioClip voiceOverClip, Action onComplete)
        {
            ...
            yield return StartCoroutine(writer.Write(text, writeSpeed, clearPrevious, waitForInput, stopVoiceover, waitForVO, soundEffectClip, onComplete));
        }
