...
namespace Fungus
{
    ...
    public class Writer : MonoBehaviour, IDialogInputListener
    {
        ...
        protected float currentWritingSpeed = 10;
        ...
        protected virtual IEnumerator ProcessTokens(List<TextTagToken> tokens, bool stopAudio, System.Action onComplete)
        {
            ...
            for (int i = 0; i < tokens.Count; ++i)
            {
                ...
                case TokenType.SpeedStart:
                    TryGetSingleParam(token.paramList, 0, currentWritingSpeed, out currentWritingSpeed);
                    break;
                    
                case TokenType.SpeedEnd:

                        currentWritingSpeed = currentWritingSpeed;
                    break;
        ...
        public virtual IEnumerator Write(string content, float writeSpeed, bool clear, bool waitForInput, bool stopAudio, bool waitForVO, AudioClip audioClip, System.Action onComplete)
        {
            if (clear)
            {
                textAdapter.Text = "";
            ...
            currentWritingSpeed = writeSpeed;
